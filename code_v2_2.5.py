...
def main(
    checkpoint_path: str = 'Qwen/Qwen2.5-VL-7B-Instruct',
    ...
    if eval_train:
        ...
        for idx, row in train_df.iterrows():
            ...
            # Log progress
            logging.info(f"Val: Processed {idx + 1}/{len(train_df)} samples, Current Accuracy: {results_train_df[results_train_df['answer'] == results_train_df['gt']].shape[0]/results_train_df.shape[0]}")

        logging.info(f"Final accuracy for train data: {results_train_df[results_train_df['answer'] == results_train_df['gt']].shape[0]/results_train_df.shape[0]}")
